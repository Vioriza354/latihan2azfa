    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_object:
                ...
                jelema.setName("RADEN AZFA FARIS");
                    jelema.setAge(17);

                        jelema.setEmail("radenazfa@gmail.com");

                jelema.setCity("Bandung");
                    Intent moveWithObjectIntent = new Intent(MainActivity.this,
                        MoveWithObjectActivity.class);
                moveWithObjectIntent.putExtra(MoveWithObjectActivity.EXTRA_PERSON, jelema);
                startActivity(moveWithObjectIntent);
                break;

            case R.id.btn_dial_number:
                String phoneNumber = "083822922668";
